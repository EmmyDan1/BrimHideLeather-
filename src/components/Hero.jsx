    ...
    <div className="relative h-screen min-h-[600px] flex items-center">
      ...
      <div className="container relative z-10 px-4 mx-auto text-center text-amber-100">
        ...
        <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto">
          Premium leather products crafted with traditional techniques and
          modern design.
        </p>
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="bg-transparent text-white border-white hover:bg-white hover:text-charcoal"
          >
            Custom Work
          </Button>
        </div>
